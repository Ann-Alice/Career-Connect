<?php
echo "<h2>🗄️ Importing Existing ERIS Database</h2>";
...
if ($conn) {
    ...
    if (mysqli_query($conn, "CREATE DATABASE IF NOT EXISTS erisdb")) {
        echo "<p style='color: green;'>✅ Database 'erisdb' ready</p>";
            ...
            if (file_exists($sql_file)) {
                ...
                if ($table_count > 0) {
                    ...
                    if ($table_count >= 5) {
                        ...
                        echo "<p>Your ERIS application database is now ready with all tables and data.</p>";
