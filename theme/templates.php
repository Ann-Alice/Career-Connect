...
<div id="wrapper" class="home-page">
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+233) 25 764 9875</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Career Connect<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
  ...
  ?>
      ...
      if (isset($_GET['q'])) {
       ...
       // Check if the content file exists and is readable before requiring it
       if (isset($content) && !empty($content) && file_exists($content) && is_readable($content)) {
           require_once $content;
       } else {
           echo '<div class="alert alert-danger">
                   <strong>Error:</strong> The requested page could not be loaded. Please try another page or contact the administrator.
                 </div>';
       }
        ?>   
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Connect GH,<br>
           Accra, Ghana.</address>
          <p>
            <i class="icon-phone"></i> +233 25 764 9875 <br>
            <i class="icon-envelope-alt"></i> connectgh@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Connect GH 2025 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
